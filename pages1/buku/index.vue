...
const getBooks = async () => {
  const { data, error } = await supabase.from("Buku").select(`*, Kategori(*)`).ilike("judul, penulis, deskripsi, tahun_terbit, penerbit, jumlah_halaman, cover, kategori, rak", `%${keyword.value}%`);

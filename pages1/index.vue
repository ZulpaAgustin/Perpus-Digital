        ...
        <form class="mt-5" @submit.prevent="kirimData">
          ...
          <div class="mb-4">
            <select v-model="form.keanggotaan" class="form-control form-control-lg form-select rounded-5">
              ...
              <option v-for="(member, i) in members" :key="i" :value="member.id" {{ member.nama }}>Siswa</option>
              <option v-for="(member, i) in members" :key="i" :value="member.id" {{ member.nama }}>Guru</option>
              <option v-for="(member, i) in members" :key="i" :value="member.id" {{ member.nama }}>Staf</option>
              <option v-for="(member, i) in members" :key="i" :value="member.id" {{ member.nama }}>Umum</option>
            </select>
          </div>
          <div class="mb-4">
            <div class="row">
